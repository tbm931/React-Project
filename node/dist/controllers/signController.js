...
const signInPrivate = async (req) => {
    const response = { message: "fail", user: { userName: "", idNumber: "", pw: "", id: 0 }, token: "", error: "userName not exist", role: 'client', business: null };
    ...
    if (findUserModel == null) {
        ...
        if (findClientModel != null) {
            const findClient = findClientModel.toJSON();
